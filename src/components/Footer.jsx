                ...
                <footer className="bg-white dark:bg-gray-900">
                    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                            ...
                            <div className="grid grid-cols-3 gap-4 sm:gap-6 sm:grid-cols-3">
                                <div>
                                    ...
                                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                        ...
                                        <li>
                                            <a href="https://tailwindcss.com/" className="hover:underline text-xs md:text-sm lg:text-sm">Tailwind CSS</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                        ...
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy" className="hover:underline text-xs md:text-sm lg:text-sm">Discord</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                        ...
                                        <li>
                                            <a href="#" className="hover:underline text-xs md:text-sm lg:text-sm">Terms &amp; Conditions</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">@copyright {new Date().getFullYear()} <a href="https://flowbite.com/" className="hover:underline font-bold">Nay Thu Naing</a>. All Rights Reserved.
                            </span>
                            <div className="flex mt-4 sm:justify-center sm:mt-0">
                                <Link to="https://facebook.com/naythunaing.mm" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                ...
                                <Link to="https://github.com/naythunaing-mm" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
